...
import math
from module.tokenizer import Scale_Embedding
MIN_NUM_PATCHES = 16
...
class ViTPatch(nn.Module):
    def __init__(self, *, image_size, patch_size, hidden_size, num_classes, depth, heads,
                 mlp_dim, classifier, channels=3, dropout=0., emb_dropout=0.):
        super().__init__()
...
class Self_Attention(nn.Module):
    def __init__(self, d_model=768, cls_number=100, pretrained=True, classifier=False):
        ...
        if pretrained:
            checkpoint = torch.load("./module/ViT-B_16.pth")
